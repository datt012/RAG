...
const std::unordered_map<AnimationKey, std::pair<int, int>> SniperMob::s_AnimationMap = {
	...
	{{true, true, DirectionGun::LEFT_UP}, {1, 8}},		
	{{true, true, DirectionGun::RIGHT_UP}, {1, 8}},		
	{{true, true, DirectionGun::LEFT_DOWN}, {1, 8}},		
	{{true, true, DirectionGun::RIGHT_DOWN}, {1, 8}},		
	...
	{{false, true, DirectionGun::LEFT_UP}, {1, 8}},		
	{{false, true, DirectionGun::RIGHT_UP}, {1, 8}},		
	{{false, true, DirectionGun::LEFT_DOWN}, {1, 8}},		
	{{false, true, DirectionGun::RIGHT_DOWN}, {1, 8}},
};
SniperMob::SniperMob(std::shared_ptr<SpriteAnimationPlayer> sprite) : Enemy(sprite) {}
SniperMob::~SniperMob() {}
void SniperMob::Init() {
...
void SniperMob::Shoot() {
	...
	if (bullet) {
		...
		p.y = Get2DPosition().y + static_cast<float>(GetHeight()) / ORIGINAL_SNIPER_SIZE_H * 28 + (-bullet->GetHeight() / 2.0f);
