...
const std::unordered_map<AnimationKey, std::pair<int, int>> RPGMob::s_AnimationMap = {
	...
	{{true, true, DirectionGun::LEFT_UP}, {1, 5}},		// NEED EDIT
	{{true, true, DirectionGun::RIGHT_UP}, {1, 5}},		// NEED EDIT
	{{true, true, DirectionGun::LEFT_DOWN}, {1, 5}},		// NEED EDIT
	{{true, true, DirectionGun::RIGHT_DOWN}, {1, 5}},		// NEED EDIT
	...
	{{false, true, DirectionGun::LEFT_UP}, {1, 5}},		// NEED EDIT
	{{false, true, DirectionGun::RIGHT_UP}, {1, 5}},		// NEED EDIT
	{{false, true, DirectionGun::LEFT_DOWN}, {1, 5}},		// NEED EDIT
	{{false, true, DirectionGun::RIGHT_DOWN}, {1, 5}},	// NEED EDIT
	// ...
};

RPGMob::RPGMob(std::shared_ptr<SpriteAnimationPlayer> sprite) :
	Enemy(sprite)
{
}
...
void RPGMob::Shoot()
{
	...
	if (bullet) {
		...
		p.y = Get2DPosition().y +
			static_cast<float>(GetHeight()) / ORIGINAL_RPGMOB_SIZE_H * 26 +
