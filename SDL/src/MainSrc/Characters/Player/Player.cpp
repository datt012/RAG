...
const std::unordered_map<AnimationKey, std::pair<int, int>> Player::s_AnimationMap = {
	...
	{{true, false, DirectionGun::LEFT_UP}, {56, 63}},		
	{{true, false, DirectionGun::RIGHT_UP}, {56, 63}},		
	{{true, false, DirectionGun::LEFT_DOWN}, {64, 71}},	
	{{true, false, DirectionGun::RIGHT_DOWN}, {64, 71}},	
	...
	{{true, true, DirectionGun::LEFT_UP}, {72, 79}},		
	{{true, true, DirectionGun::RIGHT_UP}, {72, 79}},	
	{{true, true, DirectionGun::LEFT_DOWN}, {80, 87}},		
	{{true, true, DirectionGun::RIGHT_DOWN}, {80, 87}},		
	...
	{{false, false, DirectionGun::LEFT_UP}, {51, 51}},		
	{{false, false, DirectionGun::RIGHT_UP}, {51, 51}},		
	{{false, false, DirectionGun::LEFT_DOWN}, {88, 88}},	
	{{false, false, DirectionGun::RIGHT_DOWN}, {88, 88}},
	...
	{{false, true, DirectionGun::LEFT_UP}, {52, 53}},		
	{{false, true, DirectionGun::RIGHT_UP}, {52, 53}},		
	{{false, true, DirectionGun::LEFT_DOWN}, {54, 55}},		
	{{false, true, DirectionGun::RIGHT_DOWN}, {54, 55}},	
};
Player::Player(std::shared_ptr<SpriteAnimationPlayer> sprite) : Character(sprite) {}
Player::~Player() {}
void Player::Init() {
...
void Player::Shoot() {
	...
	if (bullet) {
		...
		p.y = Get2DPosition().y + static_cast<float>(GetHeight()) / ORIGINAL_PLAYER_SIZE_H * (isCrouch ? 32 : 26) + (-bullet->GetHeight() / 2.0f);
