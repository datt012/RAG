...
void Character::DrawHPBar(SDL_Renderer* renderer, const Vector2& position, int currentHP, int maxHP, int barWidth, int barHeight, SDL_Color bgColor, SDL_Color hpColor, bool isWorldPosition) {
